...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-color: #50B4D8">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="" method="POST">
					...
					<div class="flex-c-m">
						<a href="https://www.facebook.com/denpasarkota/" class="login100-social-item bg1">
							<i class="fa fa-facebook"></i>
						</a>

						<a href="https://twitter.com/DenpasarKota" class="login100-social-item bg2">
				...
				<?php
				    if(isset($_POST['login'])){
				        ...
				        if ($row == 1) {
				        	//jalankan prosedure seleksi password
